...
import { LyricsComponent } from 'app/entities/lyrics/lyrics.component';
import { LyricsService } from 'app/entities/lyrics/lyrics.service';
import { Lyrics } from 'app/shared/model/lyrics.model';

describe('Component Tests', () => {
  describe('Lyrics Management Component', () => {
    let comp: LyricsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LyricsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.lyrics && comp.lyrics[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
