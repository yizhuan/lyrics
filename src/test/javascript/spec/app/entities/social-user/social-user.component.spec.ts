...
import { SocialUserComponent } from 'app/entities/social-user/social-user.component';
...
describe('Component Tests', () => {
  describe('SocialUser Management Component', () => {
    let comp: SocialUserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SocialUserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.socialUsers && comp.socialUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
